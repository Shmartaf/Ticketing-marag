...
describe('API Endpoints', () => {
  ...
  it('POST /boards - create board', async () => {
    const newBoard = {"_id": "6608238ac439c4adb28502c3",
    "username": "admin",
    ...
    expect(response.body).toEqual({"_id": "6608238ac439c4adb28502c3",
    "username": "admin",
    "board_name": "test board create 2",
    "users": [],
    "team": "65fda85762fb9b8527c7e4bf",
  ...
  it('UPDATE /boards/:id - update board', async () => {
    ...
    const id = '6608238ac439c4adb28502c3';
  ...
  it('POST /teams - create team', async () => {
    ...
    expect(response.statusCode).toBe(201);
    expect(response.body).toMatchObject(newTeamData);

  });
  it('GET /accounts - success', async () => {
